...
-- ---------------------------------------------------------------------
-- 1. USERS  (admin = LDRRMO Admin, manager = LDRRMO Personnel/Dispatcher, user = Barangay Responder)
-- ---------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS users (
    ...
    is_verified   TINYINT(1)          NOT NULL DEFAULT 0,      -- also used as active/inactive flag by Admin
...
CREATE TABLE IF NOT EXISTS activity_log (
    ...
    action        VARCHAR(100)    NOT NULL,                     -- e.g. 'login', 'clip_report_created', 'dispatch_assigned',
                                                                 -- 'departed_command_center', 'arrived_at_site',
                                                                 -- 'delay_reported', 'user_created', 'settings_updated', 'logout'
...
-- ---------------------------------------------------------------------
-- 7. SETTINGS  (key-value system configuration — managed by Admin)
-- ---------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS settings (
    setting_key     VARCHAR(100)    PRIMARY KEY,                -- e.g. 'default_avg_speed_kmh', 'delay_threshold_minutes', 'barangay_list'
...
-- =====================================================================
-- VIEW: full incident timeline for Manager/Admin analytics
...
-- =====================================================================
-- SEED: default settings (auto-inserted by app/admin/settings.php on first load,
-- included here so a fresh DB import already has sensible defaults)
-- =====================================================================
