 ...
 *
 * Now renders through the shared sidebar_shell.php, same as
 * admin_sidebar.php and responder_sidebar.php, so header, search,
 * theme toggle, and footer markup live in one place only.
 */
...
$headerIcon = '
<a class="header-icon" href="' . BASE_URL . '/app/manager/alerts.php" title="Delay Alerts">
...
render_sidebar_shell([
    'role_label'          => 'Manager Panel',
    'header_icon'         => $headerIcon,
    'search_placeholder'  => 'Search incidents, units...',
    'nav_html'            => $navHtml,
    'email'               => $managerEmail,
    'status_text'         => 'On duty — Command Center',
    'status_color'        => '#4caf7d',
]);