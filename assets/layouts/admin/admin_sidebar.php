...
<a class="header-icon" href="/app/admin/alerts.php" title="Alerts">
    ...
    ' . ($unreadAlerts > 0 ? '<div class="notif-dot"></div>' : '') . '
</a>';

ob_start();
?>
<div class="nav-section-label">Overview</div>
<a class="nav-item <?php echo navActive('dashboard', $currentPage); ?>" href="/hopeline/app/admin/dashboard.php">
...
<a class="nav-item <?php echo navActive('incidents', $currentPage); ?>" href="/hopeline/app/admin/incidents.php">
...
<a class="nav-item <?php echo navActive('analytics', $currentPage); ?>" href="/hopeline/app/admin/analytics.php">
...
<a class="nav-item <?php echo navActive('delays', $currentPage); ?>" href="/hopeline/app/admin/delays.php">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>
    Delay Reports
</a>

<div class="nav-section-label">Management</div>
<a class="nav-item <?php echo navActive('users', $currentPage); ?>" href="/hopeline/app/admin/users.php">
...
<a class="nav-item <?php echo navActive('units', $currentPage); ?>" href="/hopeline/app/admin/units.php">
...
<a class="nav-item <?php echo navActive('audit-trail', $currentPage); ?>" href="/hopeline/app/admin/audit-trail.php">
...
<a class="nav-item <?php echo navActive('settings', $currentPage); ?>" href="/hopeline/app/admin/settings.php">
